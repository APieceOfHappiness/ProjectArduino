...
int main(int argc, char* argv[]) {
    ...
    int num;
    int duration = strtod(argv[2], NULL);
    ...
    while (1) {
        ...
        printf("%lf, %lf, %lf, %lf\n", sensor_data_mean.preasure_val, sensor_data_mean.temperature_val, sensor_data_mean.sound_val, sensor_data_mean.light_val);
        fprintf(bd, "%lf, %lf, %lf, %lf\n", sensor_data_mean.preasure_val, sensor_data_mean.temperature_val, sensor_data_mean.sound_val, sensor_data_mean.light_val);
